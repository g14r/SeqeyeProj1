function varargout  = se1_linearIPIModels(what , varargin)
...
switch (what)
    case 'loadData'
        ...
        switch(type)
            case 'c'
                load([baseDir , '/se1_TranProb.mat'] , 'C')
                M = C;
                titleSuffix = 'Chunked';
            case 'r'
                load([baseDir , '/se1_TranProb.mat'] , 'R')
                M = R;
                titleSuffix = 'Random';
        end;
    ...
    case 'fit'
        ...
        save([baseDir , '/se1_fitIPI_',titleSuffix,'-norm_OLS.mat'] , 'Mdl' , '-v7.3')
        varargout={Mdl};
