function se1_TranProb(Dall)

% baseDir = '/Users/nedakordjazi/Documents/SeqEye/SeqEye1/analyze';     %macbook
baseDir = '/Users/nkordjazi/Documents/SeqEye/SeqEye1/analyze';          %iMac
...
C_Summarized  = tapply(CC , {'SN' , 'IPIarrangement' , 'BN' ,'t2Rank_n_binned' , 'T3Rank_n_binned' , 'T4Rank_n_binned'} , {'IPI' , 'nanmedian(x)'} , {'IPI_norm' , 'nanmedian(x)'} , {'Day' , 'nanmedian(x)'});
R_Summarized  = tapply(RR , {'SN' , 'IPIarrangement' , 'BN' ,'t2Rank_n_binned' , 'T3Rank_n_binned' , 'T4Rank_n_binned'} , {'IPI' , 'nanmedian(x)'} , {'IPI_norm' , 'nanmedian(x)'} , {'Day' , 'nanmedian(x)'});



save([baseDir , '/se1_TranProb.mat'])